...
def publish_message(project_id: str, topic_name: str, asset_id: int, device_id: int, build_id: int):
    ...
    future = publisher.publish(topic_path, data, device_id=str(device_id))
...
# Example usage:  python customAttribute/publish_CustomAttribute.py --asset_id=5 --device_id=5 --build_id=5